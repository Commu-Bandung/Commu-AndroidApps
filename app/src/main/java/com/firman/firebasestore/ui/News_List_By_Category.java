...
import com.firman.firebasestore.AlertDialogManager;
import com.firman.firebasestore.R;
import com.firman.firebasestore.adapter.Adapter_News_By_Category;
import com.firman.firebasestore.config.Constant;
import com.firman.firebasestore.config.JsonUtils;
...
public class News_List_By_Category extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (JsonUtils.isNetworkAvailable(News_List_By_Category.this)) {
            ...
            alert.showAlertDialog(News_List_By_Category.this, "Internet error",
                    "Koneksikan dengan internet", false);
        }
