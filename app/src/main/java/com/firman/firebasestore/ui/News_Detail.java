...
import com.firman.firebasestore.config.DatabaseHandler;
import com.firman.firebasestore.config.ImageLoader;
import com.firman.firebasestore.model.Pojo;
...
public class News_Detail extends AppCompatActivity {
    ...
    public void RemoveFav(int position)
    {
        ...
        Toast.makeText(getApplicationContext(), "Dihapus Dari Favorite", Toast.LENGTH_SHORT).show();
        menu.getItem(2).setIcon(getResources().getDrawable(R.drawable.ic_star_outline_white_48dp));
    ...
    private class ImagePagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            View imageLayout = inflater.inflate(R.layout.newpage_item, container, false);
